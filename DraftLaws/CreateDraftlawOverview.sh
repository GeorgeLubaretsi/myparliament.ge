...
java -cp /usr/local/bin/saxon9he.jar net.sf.saxon.Query DraftlawOverview-Extractor.xquery | sed '1d' > "$DraftlawOverviewXML";  
java -cp /usr/local/bin/saxon9he.jar net.sf.saxon.Query XML2CSV.xquery xml="$DraftlawOverviewXML" |sed '1d' > "DraftlawOverview";
...
java -Xmx2G -cp  /usr/local/bin/saxon9he.jar net.sf.saxon.Query DraftLaw-VoteExtractor.xquery AnalysisType=outcome > $OutcomePerLaw
java -Xmx2G -cp  /usr/local/bin/saxon9he.jar net.sf.saxon.Query DraftLaw-VoteExtractor.xquery AnalysisType=vote > $VotesPerLaw
...
java -cp  /usr/local/bin/saxon9he.jar net.sf.saxon.Query XML2CSV.xquery xml="$OutcomePerLaw" |sed '1d' > "$OutcomePerLawCSV";
java -cp  /usr/local/bin/saxon9he.jar net.sf.saxon.Query XML2CSV.xquery xml="$VotesPerLaw" |sed '1d' > "$VotesPerLawCSV";
...
java -Xmx2G -cp  /usr/local/bin/saxon9he.jar net.sf.saxon.Query DraftLawvotingAnalysis.xquery > DraftLawvotingAnalysis.html
